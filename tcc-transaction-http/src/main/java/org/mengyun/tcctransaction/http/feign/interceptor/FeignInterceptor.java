...
public class FeignInterceptor implements RequestInterceptor {
    ...
    public void apply(RequestTemplate requestTemplate) {
        ...
        if (annotation != null && TransactionContextHolder.getCurrentTransactionContext() != null) {
            requestTemplate.header(TransactionContextConstants.TRANSACTION_CONTEXT, Base64.getEncoder().encodeToString(transactionContextSerializer.serialize(TransactionContextHolder.getCurrentTransactionContext())));
        }
    }
}
