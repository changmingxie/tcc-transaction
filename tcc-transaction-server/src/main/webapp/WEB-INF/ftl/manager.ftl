            ...
            <table class="table table-hover table-striped table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button class="btn btn-info btn-xs j-edit" data-url="" data-echo="">删除</button>
                        <button class="btn btn-info btn-xs j-edit" data-url="" data-echo="">取消</button>
                        <button class="btn btn-info btn-xs j-edit" data-url="" data-echo="">确认</button>
                    </td>
                </tr>
                [/#list]
